(function(){function a(){this._eventManager=new simplejump.EventManager;this._playerSettings=new simplejump.game.PlayerSettings;this._platformSettings=new simplejump.game.PlatformSettings;this._levelSettings=new simplejump.game.LevelSettings;this._playerWon=!1;this._levelHolder=new createjs.Container;this._level=new simplejump.game.Level(this._levelSettings,this._playerSettings,this._platformSettings);this._scoreBoard=null;this._score=0;this.initialize();this._setupUI()}a.prototype.GAME_OVER="gameOver";
...
Math.pow(c.x-d.x,2)+Math.pow(c.y-d.y,2)||Math.pow(e.x-c.x,2)+Math.pow(e.y-c.y,2)>Math.pow(c.x-d.x,2)+Math.pow(c.y-d.y,2)?!1:!0};window.simplejump=window.simplejump||{};window.simplejump.game=window.simplejump.game||{};window.simplejump.game.Platform=function(b){return new a(b)}})();(function(){function a(){}a.prototype.platformWidth=100;a.prototype.platformHeight=5;a.prototype.platformColor="#6b8e23";window.simplejump=window.simplejump||{};window.simplejump.game=window.simplejump.game||{};window.simplejump.game.PlatformSettings=function(){return new a}})();(function(){function a(b){var a=this;this._playerSettings=b;this._eventManager=new simplejump.EventManager;this._jumpStartY=this._jumpStartTime=0;this._rightDown=this._leftDown=this._up=!1;this._xDown=this._timeDown=0;this._lastPlayerMove=null;this.initialize();this.drawPlayer();window.onkeydown=function(b){a._handleKeyDown(b)};window.onkeyup=function(b){a._handleKeyUp(b)}}a.prototype=new createjs.Container;a.prototype.PLAYER_MOVED="playerMoved";a.prototype.PLAYER_FALLING="playerFalling";a.prototype.JUMP_COMPLETE=
"jumpComplete";a.prototype.drawPlayer=function(){this.removeAllChildren();var b=new createjs.Shape;b.graphics.beginFill(this._playerSettings.playerColor);b.graphics.drawRect(0,0,this._playerSettings.playerWidth,this._playerSettings.playerHeight);this.addChild(b)};a.prototype.jump=function(){this._jumpStartY=this.y;this._up=!0;this._jumpStartTime=createjs.Ticker.getTime();createjs.Ticker.addListener(this)};a.prototype.stopJump=function(){createjs.Ticker.removeListener(this)};a.prototype.getLastPlayerMove=
function(){return this._lastPlayerMove};a.prototype.getEventManager=function(){return this._eventManager};a.prototype.getPlayerSettings=function(){return this._playerSettings};a.prototype.cleanup=function(){createjs.Ticker.removeListener(this);window.onkeydown=null;window.onkeyup=null};a.prototype.tick=function(){var b,a,c,d,e;b=!1;a=createjs.Ticker.getTime();c=a-this._jumpStartTime;d=this.x;e=this.y;c<this._playerSettings.jumpDuration?(this._up&&c>=this._playerSettings.jumpDuration/2&&(this.y=this._jumpStartY+
this._playerSettings.jumpHeight,this._up=!this._up),this.y=this._up?this._jumpStartY+this._quadEaseOut(c,0,this._playerSettings.jumpHeight,this._playerSettings.jumpDuration/2):this._jumpStartY+this._playerSettings.jumpHeight-this._quadEaseIn(c-this._playerSettings.jumpDuration/2,0,this._playerSettings.jumpHeight,this._playerSettings.jumpDuration/2)):(this.y=this._jumpStartY,this._up=!this._up,this._jumpStartTime=createjs.Ticker.getTime(),b=!0);this._rightDown&&(c=a-this._timeDown,c=c*this._playerSettings.jumpDistance/
this._playerSettings.jumpDuration+this._xDown,c+this._playerSettings.playerWidth>=this._playerSettings.maximumDistance&&(c=this._playerSettings.maximumDistance-this._playerSettings.playerWidth),this.x=c);this._leftDown&&(c=a-this._timeDown,c=this._xDown-c*this._playerSettings.jumpDistance/this._playerSettings.jumpDuration,0>=c&&(c=0),this.x=c);this._lastPlayerMove=new simplejump.game.PlayerMove(d,this.x,e,this.y);this._eventManager.dispatchEvent(this.PLAYER_MOVED);this._up||this._eventManager.dispatchEvent(this.PLAYER_FALLING);
b&&this._eventManager.dispatchEvent(this.JUMP_COMPLETE)};a.prototype._quadEaseIn=function(b,a,c,d){return c*(b/=d)*b+a};a.prototype._quadEaseOut=function(b,a,c,d){return-c*(b/=d)*(b-2)+a};a.prototype._handleKeyDown=function(b){39===b.keyCode&&!this._rightDown&&(this._leftDown=!1,this._rightDown=!0,this._timeDown=createjs.Ticker.getTime(),this._xDown=this.x);37===b.keyCode&&!this._leftDown&&(this._rightDown=!1,this._leftDown=!0,this._timeDown=createjs.Ticker.getTime(),this._xDown=this.x)};a.prototype._handleKeyUp=
function(b){39===b.keyCode&&(this._rightDown=!1);37===b.keyCode&&(this._leftDown=!1)};window.simplejump=window.simplejump||{};window.simplejump.game=window.simplejump.game||{};window.simplejump.game.Player=function(b){return new a(b)}})();(function(){function a(b,a,c,d){this.fromX=b;this.toX=a;this.fromY=c;this.toY=d}window.simplejump=window.simplejump||{};window.simplejump.game=window.simplejump.game||{};window.simplejump.game.PlayerMove=function(b,f,c,d){return new a(b,f,c,d)}})();(function(){function a(){}a.prototype.jumpDuration=2E3;a.prototype.jumpHeight=200;a.prototype.jumpDistance=200;a.prototype.playerWidth=50;a.prototype.playerHeight=50;a.prototype.playerColor="#000000";a.prototype.maximumDistance=500;window.simplejump=window.simplejump||{};window.simplejump.game=window.simplejump.game||{};window.simplejump.game.PlayerSettings=function(){return new a}})();(function(){function a(a){this._stage=a;this._eventManager=new simplejump.EventManager;this._label=new createjs.Text("BACK TO START","35px Verdana","#000000");this._resultTxt=new createjs.Text("Game Over.","35px Verdana","#000000");this._scoreTxt=new createjs.Text("Final Score:","35px Verdana","#000000");this._outShape=new createjs.Shape;this._overShape=new createjs.Shape;this._pressShape=new createjs.Shape;this.initialize();this._setupUI()}a.prototype=new createjs.Container;a.prototype.BACK_TO_START_CLICKED=
"backToStartClicked";a.prototype.setResult=function(a,f){this._resultTxt.text=a?"Game Over. You Won!":"Game Over. You Lost!";this._scoreTxt.text="Final Score: "+f};a.prototype.getEventManager=function(){return this._eventManager};a.prototype._setupUI=function(){var a;a=this;this._resultTxt.textAlign="center";this._resultTxt.textBaseline="alphabetic";this._resultTxt.x=this._stage.canvas.width/2;this.addChild(this._resultTxt);this._scoreTxt.textAlign="center";this._scoreTxt.textBaseline="alphabetic";
...
0,this._label.getMeasuredWidth()+40,45);this._overShape.x=this._outShape.x;this._overShape.y=this._outShape.y;this._overShape.graphics.beginFill("#00bfff");this._overShape.graphics.drawRect(0,0,this._label.getMeasuredWidth()+40,45);this._pressShape.x=this._outShape.x;this._pressShape.y=this._outShape.y;this._pressShape.graphics.beginFill("#1e90ff");this._pressShape.graphics.drawRect(0,0,this._label.getMeasuredWidth()+40,45);this.onMouseOut=function(){a.removeChildAt(0);a.addChildAt(a._outShape,0)};
this.onMouseOver=function(){a.removeChildAt(0);a.addChildAt(a._overShape,0)};this.onPress=function(){a.removeChildAt(0);a.addChildAt(a._pressShape,0)};this.onClick=function(){a.removeChildAt(0);a.addChildAt(a._overShape,0);a._eventManager.dispatchEvent(a.BACK_TO_START_CLICKED)};this.addChildAt(this._outShape,0)};window.simplejump=window.simplejump||{};window.simplejump.view=window.simplejump.view||{};window.simplejump.view.EndView=function(b){return new a(b)}})();(function(){function a(){this._eventManager=new simplejump.EventManager;this._game=null;this._playerWon=!1;this._finalScore=0;this.initialize()}a.prototype=new createjs.Container;a.prototype.GAME_OVER="gameOver";a.prototype.startGame=function(){var a=this;this._game=new simplejump.game.Game;this.addChild(this._game);this._game.getEventManager().addListener(this._game.GAME_OVER,function(){a._gameOver()})};a.prototype.getPlayerWon=function(){return this._playerWon};a.prototype.getFinalScore=function(){return this._finalScore};
a.prototype.getEventManager=function(){return this._eventManager};a.prototype._gameOver=function(){this.removeChild(this._game);this._playerWon=this._game.getPlayerWon();this._finalScore=this._game.getFinalScore();this._eventManager.dispatchEvent(this.GAME_OVER)};window.simplejump=window.simplejump||{};window.simplejump.view=window.simplejump.view||{};window.simplejump.view.GameView=function(b){return new a(b)}})();(function(){function a(a){this._stage=a;this._label=new createjs.Text("PLAY!","35px Verdana","#000000");this._overShape=new createjs.Shape;this._outShape=new createjs.Shape;this._pressShape=new createjs.Shape;this._eventManager=new simplejump.EventManager;this.initialize();this._setupUI()}a.prototype=new createjs.Container;a.prototype.PLAY_CLICKED="playClicked";a.prototype.getEventManager=function(){return this._eventManager};a.prototype._setupUI=function(){var a;a=this;this._label.textAlign="center";
...
function(){a.removeChildAt(0);a.addChildAt(a._overShape,0);a._eventManager.dispatchEvent(a.PLAY_CLICKED)};this.addChildAt(this._outShape,0)};window.simplejump=window.simplejump||{};window.simplejump.view=window.simplejump.view||{};window.simplejump.view.StartView=function(b){return new a(b)}})();(function(){function a(){this._listeners=[]}a.prototype.addListener=function(a,f){var c,d,e;c=!1;d=0;for(e=this._listeners.length;d<e;d++)if(this._listeners[d].type===a&&this._listeners[d].fn===f){c=!0;break}c||this._listeners.push({type:a,fn:f})};a.prototype.removeListener=function(a,f){var c,d,e;c=!1;d=0;for(e=this._listeners.length;d<e;d++)if(this._listeners[d].type===a&&this._listeners[d].fn===f){c=!0;break}c&&this._listeners.splice(d,1)};a.prototype.dispatchEvent=function(a){var f,c;f=0;for(c=
this._listeners.length;f<c;f++)this._listeners[f].type===a&&this._listeners[f].fn()};window.simplejump=window.simplejump||{};window.simplejump.EventManager=function(){return new a}})();(function(){function a(){this._endView=this._gameView=this._startView=this._background=this._stage=this._canvas=this._levelSettings=null}a.prototype.init=function(){var a=this;this._levelSettings=new simplejump.game.LevelSettings;this._canvas=document.getElementById("canvas");this._canvas.width=this._levelSettings.levelWidth;this._canvas.height=window.innerHeight;this._canvas.style.marginLeft=(window.innerWidth/2-this._canvas.width/2).toString()+"px";createjs.Ticker.setFPS(60);createjs.Ticker.useRAF=
